...
<table width ="550px" border="0" cellspacing="0" cellpadding="0" style=" font-family:'Open Sans'; font-size:14px; margin:0 auto; height:auto; background-color:#fffff6;">
    ...
    <table width ="550px" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #cadce6; ;margin:0 auto; height:auto; background-color:#fffff6; font-family:'Open Sans'; padding:0 15px 0 15px;">
   		<tr>
        	<td style=" font-size:20px; font-weight:600; color:#424242; padding:23px 0 0 0; letter-spacing:.5px;"><?=$subject?></td>
        </tr>
        <tr>
        	<td style=" font-size:13px; font-weight:400; color:#555353; padding:15px 0 0 0;">Hi ,<br /><br />
            </td>
        </tr>
        
        <tr>
        	<td style=" font-size:13px; font-weight:400; color:#555353; padding:15px 0 0 0;"><b>Invite from : </b>
             <?=$from?></td>
        </tr>
        ...
        <tr>
        	<td style="font-size:13px; font-weight:400; color:#555353; padding:12px 0 0 0;"><p><?=$from?> Invited you to join in somecircle click the below link: <br /><br /> <a href="<?=$sitelink?>" target="_blank"><?=$sitelink?></a></p></td>
        </tr><br />
