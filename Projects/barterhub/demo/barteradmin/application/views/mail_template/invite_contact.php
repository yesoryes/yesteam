...
<table width ="550px" border="0" cellspacing="0" cellpadding="0" style=" font-family:'Open Sans'; font-size:14px; margin:0 auto; height:auto; background-color:#fffff6;">
    ...
    <table width ="550px" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #cadce6; ;margin:0 auto; height:auto; background-color:#fffff6; font-family:'Open Sans'; padding:0 15px 0 15px;">
   		<tr>
        	<td style=" font-size:20px; font-weight:600; color:#424242; padding:23px 0 0 0; letter-spacing:.5px;">Invite from Somecircle,</td>
        </tr><br />
        <tr>
        	<td style="font-size:13px; font-weight:400; color:#555353; padding:15px 0 0 0;">Hi <?=$contact_name?>,<br /><br />
            </td>
        </tr><br />
        
         <tr>
        	<td style="font-size:13px; font-weight:400; color:#555353; padding:15px 0 0 0;">
             <p><b>Invite from : </b><?=$fname.' ['.$from.'] '?> Added you as a <strong><?=$contact?></strong> in www.somecircle.com</p></td>
        </tr><br />
        
        
        <tr>
        	<td style="font-size:13px; font-weight:400; color:#555353; padding:12px 0 0 0;"><p><?=$fname?> Invited you to join in somecircle.com click the below link: <br /><br /> <a href="<?=$login_link?>" target="_blank"><?=$login_link?></a></p></td>
        </tr><br />
        
        
        <tr>
        	<td style="font-size:13px; font-weight:400; color:#555353;"><p><strong>Username</strong> : <?=$email?> </p></td>
        </tr><br />
        
        <tr>
			<td style="font-size:13px; font-weight:400; color:#555353;"><p><strong>Password</strong> : <?=$password?></p></td>
        </tr><br />
