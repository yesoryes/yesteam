...
<div id="wrapper1">
  <div class="container">
    ...
    <div class="ip_container">
      <div class="inner_content" style="width:1620px;">
        <h1><?php echo $fetquerytab['subtitle']; ?></h1>
          ...
          <div class="ip_content1">
            ...
            <div id="scr-wrapper1" style="width:1190px">
   ...
   <!--  <div class="vertical_caurosel">
      <div id="scr-wrapper" class="scr-wrapper">
        <ul id="scroller" class="scroller">
                    <?php
                $i=1; 
  $getCar = mysql_query("SELECT * FROM template2_carousal WHERE template_content_id = '$gettid'");
...
<?php
    ...
    <?php
    $j=1;
     $getcaptioncontent = mysql_query("SELECT * FROM template2_carousal WHERE template_content_id = '$gettid'");
...
$(document).ready(function () {
  ...
  function loaded () {
	...
	myScroll = new IScroll('#scr-wrapper11', {
      scrollX: false,
      scrollY: true,
      momentum: false,
      snap: true,
