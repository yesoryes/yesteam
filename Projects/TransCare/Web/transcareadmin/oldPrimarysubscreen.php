...
$addtablecontent = mysql_query("INSERT INTO `primary_template_content` (template_id,tablename,linkname,createdon) 
    VALUES('$templateid','$tablename','$linkname','$createdOn')");
...

  {
     ...
     {    
...

       {
         ...
         $template1imagequery = mysql_query("INSERT INTO primary_template1 (linkname,title,description,logo,template_content_id) 
...

  {
...

    {
         ...
         {    
           ...
           $template1imgname=$_POST["imagecaption"][$i];
          ...
          $template1topimagequery=mysql_query("INSERT INTO `primary_template1_carousal` ( template_content_id,caption, rightfiles) 
            VALUES('$primarytemplate_id','$template1imgname', '$paname')");
...

  {
...

    {
         ...
         {    
           ...
           $temp2rgtpath = "primarytemplate2_carousal/"; // create folder 

           $temp2rgtname = $_FILES['template2rightimage']['name'][$i];

           $temp2right = $temp2rgtpath.$temp2rgtname;

           $template2imgname=$_POST["imagetitle"][$i];
          ...
          $template2rightimage=mysql_query("INSERT INTO `primary_template2_carousal` (template_content_id,caption,rightfiles)
           VALUES('$primarytemplate_id','$template2imgname' ,'$temp2right')");
...

  {
     ...
     {    
...

       {
         ...
         $template = mysql_query("INSERT INTO `primary_template5` (linkname,title,bannerimage,description,template_content_id) 
...

  {
     ...
     {    
...

       {
         ...
         $template = mysql_query("INSERT INTO `primary_template6` (linkname,title,bannerimage,description,template_content_id) 
...

  {
...

    {
      ...
      $headername=$_POST["headername"][$i];
        ...
        $template4=mysql_query("INSERT INTO `primary_template4` (linkname, title,headername,description,division,type,available,place,template_content_id) 
          VALUES('$linkname','$temp4title','$headername','$description','$division','$type','$available','$place','$primarytemplate_id')");
...

    {
      ...
      $template4addtitle=mysql_query("INSERT INTO `template4_link` (linkname, title,template_content_id) VALUES('$linkname','$temp4title','$primarytemplate_id')");
...

    {
      ...
      $eventname=$_POST["eventname"][$i];
...

        {
                    ...
                    $template3=mysql_query("INSERT INTO `primary_template3` (linkname, title,eventname,description,time,date,place,template_content_id) 
                      VALUES('$linkname','$temp3title','$eventname','$temp3description','$time','$date','$temp3place','$primarytemplate_id')");
...

      {
            ...
            $template3addtitle=mysql_query("INSERT INTO `template3_link` (linkname, title,template_content_id)
                ...
                <div id="template1rightfiles">              
                 ...
                 <div class="fileUpload btn btn-primary">
                   ...
                   <div class="fill-title"> 
                        ...
                        <label>Image caption</label> <input type="text" name="imagecaption[]" id="" value="" class="fillTitleText"> <!--<a href="#"></a>  -->
...
<div class="fill-title"> 
                        ...
                        <label>Image caption</label> <input type="text" name="imagetitle[]" id="" value="" class="fillTitleText"> 
                    </div>
                        </div>
