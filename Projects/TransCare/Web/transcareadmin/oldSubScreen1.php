...

		{
			   ...
			   {    
				   ...
				   { 
					...
					$template1topimagequery=mysql_query("INSERT INTO `template1_carousel` ( template1_rightimages,temp1imgcaption, template_content_id) VALUES('$paname','$template1imgname', '$temp_content_id')");
...

		{
			   ...
			   {    
				   ...
				   { 
					...
					$template2rightimage=mysql_query("INSERT INTO `template2_carousal` (template2_rightimages,Imagecaption, template_content_id) VALUES('$temp2right','$template2imgname' ,'$temp_content_id')");
