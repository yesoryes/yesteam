...
$addtablecontent = mysql_query("INSERT INTO `primary_template_content` 
  (template_id,tablename,linkname,createdon,parentid,screen) 
    VALUES('$templateid','$tablename','$linkname','$createdOn','$screenid','$screenname')");
 ...
 elseif($screenid != 0 && $screenname == 'screen4')
  ...
  if($tablename=="primary_template1")

  {

    $primarytemplate_id=mysql_insert_id();

  }

  else if($tablename=="primary_template2")
  ...
  else if($tablename=="primary_template3")
  ...
  else if($tablename=="primary_template4")
  ...
  else if($tablename=="primary_template5")
  ...
  //add template1 title,description and left image
if($_POST["TempName"] == 1)
{
...

  {
     ...
     {    
       ...
       $temp1topimgpath = "primarytemplate1img/"; // create folder 
    ...
    $template1query = mysql_query("INSERT INTO primary_template1
   (linkname,title,description,topimage,template_content_id) 
    VALUES('$linkname','$title','$description','$temp1target','$primarytemplate_id')");
  ...
  {
    $template1addquery = mysql_query("INSERT INTO primary_template1
   (linkname,title,description,template_content_id) 
    VALUES('$linkname','$title','$description','$primarytemplate_id')");
...
if($choosefile == "Image")
{
   ...
   {
      $path = "primary_template1_carousal/"; // create folder 
      ...
      $template1topimagequery=mysql_query("INSERT INTO `primary_template1_carousal` 
        (template_content_id,temp1imgcaption,template1_rightimages,contentchecked) 
        VALUES('$primarytemplate_id','$template1imgname','$paname','$choosefile')");
...
else if($choosefile == "Pdf")
{
  ...
  if(isset($_FILES['template1addpdf'.$i]['name']))
  {
    ...
    $path = "primarytemplate1pdffile/"; // create folder 
...
else if($choosefile == "Video")
{
    ...
    $template1topimagequery=mysql_query("INSERT INTO `primary_template1_carousal` 
      (template_content_id,temp1imgcaption,template1_rightimages,contentchecked)
       VALUES('$primarytemplate_id','$videcaption','$videourl','$choosefile')");
...
if($choosetemp2file == "Image")
{
   ...
   {
      $path = "primarytemplate2_carousal/"; // create folder 
      ...
      $template1topimagequery=mysql_query("INSERT INTO `primary_template2_carousal` 
        (template_content_id,Imagecaption,template2_rightimages,contentchecked) 
        VALUES('$primarytemplate_id','$template2imgcaption','$temp2imgname','$choosetemp2file')");
...
else if($choosetemp2file == "Pdf")
{
  ...
  if(isset($_FILES['template2addpdf'.$i]['name']))
  {
    ...
    $path = "primarytemplate2pdffile/"; // create folder 
    ...
    $template2pdfcaption=mysql_real_escape_string($_POST["template2pdfcaption".$i]);
      ...
      $template1topimagequery=mysql_query("INSERT INTO `primary_template2_carousal`
       (template_content_id,Imagecaption,template2_rightimages,contentchecked) 
       VALUES('$primarytemplate_id','$template2pdfcaption','$paname','$choosetemp2file')");
...
else if($choosetemp2file == "Video")
{
    ...
    $template1topimagequery=mysql_query("INSERT INTO `primary_template2_carousal` 
      (template_content_id,Imagecaption,template2_rightimages,contentchecked)
       VALUES('$primarytemplate_id','$temp2videcaption','$temp2videourl','$choosetemp2file')");
...
if($_POST["TempName"] == 2)
 {
...

  {
     ...
     {  
       $temp2topimgpath = "primarytemplate2img/"; // create folder 

       $temp2topimgname = $_FILES['template2topimage']['name'];

       $temp2target = $temp2topimgpath.$temp2topimgname;

       $movetemplate2files=move_uploaded_file($_FILES['template2topimage']['tmp_name'],$temp2target);

    $template2 = mysql_query("INSERT INTO `primary_template2` (linkname,title,subtitle,image,description,template_content_id) 
          VALUES('$linkname','$temp2title','$temp2subtitle','$temp2target','$temp2desc','$primarytemplate_id')");
  ...
  {
    $template2 = mysql_query("INSERT INTO `primary_template2` 
      (linkname,title,subtitle,description,template_content_id) 
     VALUES('$linkname','$temp2title','$temp2subtitle','$temp2desc','$primarytemplate_id')");
  }
 }
...
if($_POST["TempName"] == 5)
...

  {
     ...
     {    
       $temp5bannerimgpath = "primary_template5/"; // create folder 
       ...
       {
    $template5title = mysql_query("INSERT INTO `primary_template5`
     (linkname,title,bannerimage,description,template_content_id) 
          VALUES('$linkname','$temp5title','$temp5target','$temp5desc','$primarytemplate_id')");        
 ...
 $template5title = mysql_query("INSERT INTO `primary_template5`
     (linkname,title,description,template_content_id) 
          VALUES('$linkname','$temp5title','$temp5desc','$primarytemplate_id')");      
  }
...

  {
     ...
     {    
       ...
       $temp6bannerimgpath = "primary_template6/"; // create folder 
...

       {
           ...
           $template6addtitle = mysql_query("INSERT INTO `primary_template6` (linkname,title,bannerimage,description,template_content_id) 
          VALUES('$linkname','$temp6title','$temp6target','$temp6desc','$primarytemplate_id')");
       }
  ...
  {
     $template6addtitle = mysql_query("INSERT INTO `primary_template6`
      (linkname,title,description,template_content_id) 
          VALUES('$linkname','$temp6title','$temp6desc','$primarytemplate_id')");
  }
  }
  ...
  {
      $save4link = mysql_query("INSERT INTO `primary_template4` (linkname, title,template_content_id) 
        VALUES('$linkname','$temp4title','$primarytemplate_id')");
    if($save4link)
    {
      $get4InserId = mysql_insert_id();

    
    $get4Id = $_POST['hiddentemp4value'];
...

    {
      ...
      $place=mysql_real_escape_string($_POST["Place".$i]);
          ...
          {
          $tempeven4insert = mysql_query("INSERT INTO `primary_template4_event`
           (tl4_id, headername, description, division, type, available, place, created_on) 
           VALUES('$get4InserId', '$headername', '$description', '$division', '$type', '$available', '$place', '$createdOn' )");
          }
...

  {
      ...
      $savelink = mysql_query("INSERT INTO `primary_template3` (linkname, title,template_content_id)
       VALUES('$linkname','$temp3title','$primarytemplate_id')");
...
if($event3name != "" || $event3desc != "" || $event3time != "" || $event3date != "" ||  $event3place != "")
    {
$tempeveninsert = mysql_query("INSERT INTO `primary_template3_event`
 (tl3_id, eventname, description, time, date, place, created_on) 
 VALUES('$getInserId', '$event3name', '$event3desc', '$event3time', '$event3date', '$event3place', '$createdOn' )");
    }
    ...
    if($Screen != 'screen7')

      {
        ...
        echo '<meta http-equiv="refresh" content="0;Primarysubscreen.php?screenid='.$PassId.'&screen='.$Screen.'" />';
$msg="Subscreen added successfully,if u want add another subscreen continue with this page";
      }
...
<?php if(isset($msg)){ ?> 
  ...
  <h2 style="border:#000; padding:10px; background-color: #B2DBB2;margin: 10px 184px;color: #626262;border-radius: 4px;" id="showsccessmesg" ><?php echo $msg; ?></h2>
...
<h3>Fill Content - Template C</h3>
            ...
            <div class="fillSec">
                ...
                <div class="contentSecTitle">
                    ...
                    <h3 style="line-height: 20px">Left Part- Text<br>
<span style="color:#000; font-weight: 100; font-size: 12px;">(Note : webpage copy text directly Don't put.)</span></h3>
                ...
                <div class="left-part">
                    ...
                    <div class="text-area">
                      ...
                      <textarea style="width: 100%;" class="jqte-test" rows="4" name="temp1desc" ></textarea>
            ...
            <div class="section2">
               ...
               <div class="contentSecTitle">
                     ...
                     <h3 style="line-height: 20px">Top Image<br>
<span style="color:#000; font-weight: 100; font-size: 12px;">(Note : size 446px x 400px)</span></h3>
                ...
                <input type="text" id="template1_topimage" value="" class="upLoadText">
                 ...
                 <div class="fileUpload btn btn-primary">
                     ...
                     <input id="temp1" onchange="template1topimage(this)" name="template1image" type="file" class="upload" >
        ...
        <div class="section2">
              ...
              <input type="text" name="imagecaption1"  id="imagecaption1" class="fillTitleText"> <!--<a href="#"></a>  -->
...
<a href="javascript:void(0);"  onClick="removetemplate1rightfiles(1);"></a>
                        ...
                        <div id="videoidcontent1" style="display:none;">
...
<a href="javascript:void(0);"  onClick="removetemplate1rightfiles(1);"></a>
                     ...
                     <div style="clear:both"></div>
                     <span style='color:red;font-size:14px'>You can add minimum 8 files and maximum 15</span>
            ...
            <div class="fillSec">
                ...
                <div class="current-textarea">  
                    ...
                    <div class="text-area">
                       ...
                       <label style="padding-left:0">Descrption</label><textarea rows="4" class="jqte-test" name="temp2desc"></textarea>
          ...
          <!--  <div class="section2">
                ...
                <div class="subSec">                
                    ...
                    <div class="subSec1" id="templateappendClass1">  
                        ...
                        <h2 class="contentSec2Left" style="margin-top: 10px;font-weight: 500;margin-bottom: 10px;">Slect your option:</h2>
                        <div class="" style="clear:both"></div>
                        <div class="contentSec2Left">
                        ...
                        <div id="imageidcontenttwo1">
                            ...
                            <label class="imgCaption">Image caption</label> 
                            <div style="clear:both;"></div>
                            <input type="text" name="template2imagecaption1" id="template2imagecaption1" value="" class="fillTitleText"> 
                            </div>
                            </div>
                        ...
                        <div id="pdfidcontenttwo1" style="display:none;">
                            ...
                            <label class="imgCaption">Pdf caption</label> 
                            <div style="clear:both;"></div>
                            <input type="text" name="template2pdfcaption1" id="template2pdfcaption1" value="" class="fillTitleText"> 
                            </div>
                            </div>
<div class="deLete">
...
<a href="javascript:void(0);" onclick="removetemplate2rightfiles(1)"></a>
                        ...
                        <div id="videoidcontenttwo1" style="display:none;">
                            
                            <div class="contentSec2Left fill-title" style="padding-top: 10px;"> 

                            <label class="imgCaption">Video Url <span>(please provide embed youtube url)</span></label> <br>
                            <textarea rows="3" name="template2addvideo1" id="template2addvideo1" value="" class="fillTitleText"> </textarea>

                            </div>
                            <div class="contentSec2Left fill-title" style="padding-bottom: 10px;"> 

                            <label class="imgCaption">Video Caption</label>
                            <div style="clear:both;"></div>
...
<div id="template3addmore"> 
        <div class="event-sec" >     
                    ...
                    <div class="ses1"> 
<input type="hidden" id="temp3hiddenvalue" value="1" name="hiddentemp3value"/>  
                           <p id="temp3count1">1</p>
                    ...
                    <div class="event-title"><label>Event Name</label> <input type="text" name="eventname1" id="eventname1" value="" class="subtitle-text" placeholder="Account Executive"></div>
...
<div id="template4addmore"> 
        <div class="event-sec">   
                    ...
                    <div class="ses1">
                       ...
                       <input type="hidden" id="temp4hiddenvalue" value="1" name="hiddentemp4value"/>  
                           <p id="temp4count1">1</p>
        ...
        <label>Main Title</label> <input type="text" class="fillTitleText" name="temp5title"placeholder="Lorem Ipsum"><!--  <a href="#">Edit</a>  -->
            ...
            <div class="section2"> 
                ...
                <div class="contentSecTitle">
                    ...
                    <h3 style="line-height: 20px">Banner Image<br>
<span style="color:#000; font-weight: 100; font-size: 12px;">(Note : Width 1602px)</span></h3>
            ...
            <div class="fillSec"> 
                ...
                <div class="current-textarea">  
                    ...
                    <div class="text-area">
                      ...
                      <label style="padding-left:0">Description</label>  <textarea rows="4" class="jqte-test" name="temp5desc" ></textarea>
        ...
        <label>Main Title</label> <input type="text" class="fillTitleText" name="template6title" placeholder="Lorem Ipsum">  <!--<a href="#">Edit</a>  -->
            ...
            <div class="section2">  
                ...
                <div class="contentSecTitle">
                    ...
                    <h3 style="line-height: 20px">Banner Image<br>
<span style="color:#000; font-weight: 100; font-size: 12px;">(Note : size 536px x 647px)</span></h3>
            ...
            <div class="fillSec"> 
                ...
                <div class="current-textarea">  
                    ...
                    <div class="text-area">
                       ...
                       <label style="padding-left:0">Desription</label>  <textarea rows="4" class="jqte-test" name="temp6desc" ></textarea>
...
<div id="loader" style="display:none;"><img src="LoaderIcon.gif" alt="" />Loading!</div>
          ...
          <input type="hidden" value="<?php echo $spage?>" name="screenname" />
              ...
              <input type="submit" value="Save" name="Save" class="save_button" id="btnSubmit">
...
$('#btnSubmit').click(function() {
    ...
    $('#uploadform').submit();
  var team1 = '<?php echo $msg; ?>'; 
  
    if(team1 != "")
    {
$('#showsccessmesg').hide().fadeOut(5000);
    }
...

{
  ...
  {     
    ...
    var langCount=$('#temp3hiddenvalue').val();

    $('#temp3hiddenvalue').val(parseInt(langCount)-1);
...

  {
    ...
    var langCount=$('#temp4hiddenvalue').val();

    $('#temp4hiddenvalue').val(parseInt(langCount)-1);
