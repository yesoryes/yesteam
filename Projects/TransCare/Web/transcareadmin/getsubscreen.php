...
include('connect.php');
    ...
    if(isset($_POST['cont'])){
        ...
        $query1 = mysql_query("SELECT * FROM `template_content` WHERE id = '$sid'");
        ...
        <div class="linkName">
           ...
           if(!empty($fetquery["template_id"]) && $fetquery["template_id"] == 1){ 
            ...
            $query = mysql_query("SELECT * FROM template1_link WHERE template_content_id = ".$fetquery['id']."");
  ...
  <div class="fillContent" id="subscreen1">        
           ...
           <div class="section2">
                ...
                <?php 
                  ...
                  $getimage = mysql_query("SELECT * FROM template1_carousel WHERE template_content_id = '$sid'");
...
<input type="hidden" name="edittemplate1choose<?php echo $i;?>" value="Image" id="edittemplate1option<?php echo $i;?>">
 ...
 <?php 
          ...
          <div class="deLete">
              ...
              <a href="javascript:void(0);"  onClick="editremovetemplate1rightfiles(<?php echo $fetcImg["template1_rightid"]; ?>);"></a>
...
?>
        ...
        if(!empty($fetquery["template_id"]) && $fetquery["template_id"] == 2){
            ...
            $query = mysql_query("SELECT * FROM template2_link WHERE template_content_id = ".$fetquery['id']."");
...
<!-- <div class="section2">
            ...
            $getimage = mysql_query("SELECT * FROM template2_carousal WHERE template_content_id = '$sid'");
 ...
 <?php 
        ...
        <input type="text" id="edittemplate2_rightimage<?php echo $i; ?>" name="hiddenedittemplate2rgtimgs<?php echo $i; ?>" value="<?php echo $fetcImg["template2_rightimages"];?>" class="upLoadText">
          ...
          ?>
              ...
              <input type="text" id="edittemplate2_pdf" name="hiddenedittemplate2pdffiles<?php echo $i; ?>" value="<?php echo $fetcImg["template2_rightimages"];?>" class="upLoadText">
   ...
   <input type="hidden" id="temp2updateid" name="hiddentemplate2id" value="<?php echo $counttemplate2Im;?>">
        ...
        <?php 
         ...
         if(!empty($fetquery["template_id"]) && $fetquery["template_id"] == 3){
            ...
            $query = mysql_query("SELECT * FROM template3_link WHERE template_content_id = ".$fetquery['id']."");
      ...
      <div class="event-sec" id="edittemplate3appendClass<?php echo $i; ?>">      
                    ...
                    <div class="event-content">      
                      ...
                      <div class="deLete">
                                    ...
                                    <a href="" onClick="editremovetemplate3(<?php echo $fetchMulti['te_id']; ?>)"></a>
    ...
    <div class="addMore" id="template2addbutton">
        ...
        <?php }
         ...
         if(!empty($fetquery["template_id"]) && $fetquery["template_id"] == 4){
            ...
            $query = mysql_query("SELECT * FROM template4_link WHERE template_content_id = ".$fetquery['id']."");
...
<a href="" onClick="editremovetemplate4(<?php echo $fetchMultitemplate4['te_id']; ?>)"></a>
    ...
    <div class="addMore" id="template2addbutton">
                ...
                if(!empty($fetquery["template_id"]) && $fetquery["template_id"] == 5){
                    ...
                    $query = mysql_query("SELECT * FROM template5_link 
...
-->
        ...
        if(!empty($fetquery["template_id"]) && $fetquery["template_id"] == 6){
            ...
            $query = mysql_query("SELECT * FROM template6_link WHERE template_content_id = ".$fetquery['id']."");
