...
$quers = mysql_query("UPDATE primary_template_content SET linkname = '$linkname' WHERE id = '$linkId'");
}
...
$temp_contentid=$getelement;
  ...
  $uptemp = mysql_query("UPDATE primary_template1 SET linkname = '$linkname',title = '$title', description = '$desc' WHERE id = '$temp1id'");
...

  {
    ...
    unlink($tempremove);
       ...
       $temppath = "primarytemplate1img/"; // create folder 
       ...
       $qur = mysql_query("UPDATE primary_template1 SET topimage = '$tempN' WHERE id = '$temp1id'");
	...
	for($i=1; $i <= $_POST["hiddentemplateid"]; $i++) 
	{
      ...
      else if($_FILES['edittemplate1addrgtimage'.$i]['size'] > 0)
      {
        ...
        $template1imgname=mysql_real_escape_string($_POST["editimagecaption".$i]);
				 ...
				 $template1topimagequery=mysql_query("UPDATE  `primary_template1_carousal` SET
				 temp1imgcaption='$template1imgname',
				 template1_rightimages='$paname',contentchecked='$choosefile' WHERE id='$id'");
      ...
      {
         $paname= $_POST['hiddenedittemplate1pdffiles'.$i];
      }
      ...
      $template1imgname=mysql_real_escape_string($_POST["editpdfcaption".$i]);
				...
				$template1topimagequery=mysql_query("UPDATE  `primary_template1_carousal` SET temp1imgcaption='$template1imgname',
				template1_rightimages='$paname',contentchecked='$choosefile' WHERE id='$id'");
		...
		$template1topimagequery=mysql_query("UPDATE  `primary_template1_carousal` SET temp1imgcaption='$videcaption',
		template1_rightimages='$videourl',contentchecked='$choosefile' WHERE id='$id'"); 
...
if($choosefile == "Image")
{
   ...
   if($_FILES['template1addrgtimage'.$i]['size'] > 0)
   {
      ...
      $template1topimagequery=mysql_query("INSERT INTO `primary_template1_carousal` 
        ...
        VALUES('$temp_contentid','$template1imgname','$paname','$choosefile')");
...
else if($choosefile == "Video")
{
    ...
    $template1topimagequery=mysql_query("INSERT INTO `primary_template1_carousal` 
      (template_content_id,temp1imgcaption,template1_rightimages,contentchecked)
       VALUES('$temp_contentid','$videcaption','$videourl','$choosefile')");
...
$temp_content_id=$getelement;
  ...
  $uptemp = mysql_query("UPDATE primary_template2 SET linkname = '$linkname', title = '$title', 
  	subtitle = '$subtitle1', description = '$desc1' WHERE id = '$temp1id'");
...

  {
     ...
     {    
       ...
       $temppath = "primarytemplate2img/"; // create folder 
       ...
       $qur = mysql_query("UPDATE primary_template2 SET image = '$tempN' WHERE id = '$temp1id'");
...
if($_FILES['edittemplate2addrgtimage'.$i]['size'] == 0)
      {
        $paname=$_POST['hiddenedittemplate2rgtimages'.$i];
      ...
      else if($_FILES['edittemplate2addrgtimage'.$i]['size'] > 0)
      {
        ...
        $paname = $path.$name;
        $movefile=move_uploaded_file($_FILES['edittemplate2addrgtimage'.$i]['tmp_name'], $path.$name);
      }
         $template2imgname=mysql_real_escape_string($_POST["edittemplate2imagecaption".$i]);
			
				 $template2topimagequery=mysql_query("UPDATE  `primary_template2_carousal` SET
				 Imagecaption='$template2imgname',template2_rightimages='$paname',contentchecked='$template2choosefile' WHERE id='$id'");
      ...
      else if($_FILES['edittemplate2addpdf'.$i]['size'] > 0)
      {
        ...
        $paname = $path.$name;
        $movefiles=move_uploaded_file($_FILES['edittemplate2addpdf'.$i]['tmp_name'], $path.$name);
      }			
				$template2imgname=mysql_real_escape_string($_POST["edittemplate2pdfcaption".$i]);

				
				$template1topimagequery=mysql_query("UPDATE  `primary_template2_carousal` SET 
          Imagecaption='$template2imgname',
				template2_rightimages='$paname',contentchecked='$template2choosefile' WHERE id='$id'");
		...
		$template1topimagequery=mysql_query("UPDATE  `primary_template2_carousal`
     SET Imagecaption='$template2videcaption',
		template2_rightimages='$template2videourl',contentchecked='$template2choosefile' WHERE id='$id'"); 
...
if($choosetemp2file == "Image")
{
   ...
   if($_FILES['template2addrgtimage'.$i]['size'] > 0)
   {
      ...
      $template1topimagequery=mysql_query("INSERT INTO `primary_template2_carousal` 
        ...
        VALUES('$temp_content_id','$template2imgcaption','$temp2imgname','$choosetemp2file')");
...
else if($choosetemp2file == "Pdf")
{
  ...
  if($_FILES['template2addpdf'.$i]['size'] > 0)
  {
    ...
    $template2pdfcaption=mysql_real_escape_string($_POST["template2pdfcaption".$i]);
      ...
      $template1topimagequery=mysql_query("INSERT INTO `primary_template2_carousal`
       (template_content_id,Imagecaption,template2_rightimages,contentchecked) 
       VALUES('$temp_content_id','$template2pdfcaption','$paname','$choosetemp2file')");
...
else if($choosetemp2file == "Video")
{
    ...
    $template1topimagequery=mysql_query("INSERT INTO `primary_template2_carousal` 
      (template_content_id,Imagecaption,template2_rightimages,contentchecked)
       VALUES('$temp_content_id','$temp2videcaption','$temp2videourl','$choosetemp2file')");
...
if(isset($_POST['template3']))
{
  ...
  $template3=mysql_query("UPDATE `primary_template3` SET linkname='$linkname',title = '$title' WHERE id = '$template3templatecontentid'");
...
if($_POST["hiddentemp3value"] > 0)
{
   ...
   for($i=0; $i<count($_POST["eeventname"]); $i++) 

    {
            ...
            $template3=mysql_query("UPDATE `primary_template3_event` SET 
             eventname = '$eventname',description = '$temp3description', time = '$time',date = '$date', place = '$temp3place' 
             WHERE te_id = '$temp3id'");
...
if($_POST["hiddenaddtemplate3id"]-1 > 0)
{
  if(count($_POST["aeeventname"]) > 0)
  {
          ...
          $adate=$_POST["aedate"][$i];
                    ...
                    {
                    $template3=mysql_query("INSERT INTO `primary_template3_event`
                    ( tl3_id, eventname, description, time, date, place, created_on)
                    VALUES('$template3templatecontentid','$aeventname','$atemp3description','$atime','$adate','$atemp3place','$createdOn')");
                    }
...
$template4=mysql_query("UPDATE `primary_template4` SET linkname='$linkname',title = '$title' WHERE id = '$template4templatecontentid'");
      ...
      $headername=mysql_real_escape_string($_POST["eheadername"][$i]);
         ...
         $description=mysql_real_escape_string($_POST["etemp4description"][$i]);
           ...
           $type=mysql_real_escape_string($_POST["eType"][$i]);
             ...
             $template3=mysql_query("UPDATE `primary_template4_event` 
  ...
  if(count($_POST["aeheadername"]) > 0 )
  {
...

    {
      ...
      $aheadername=mysql_real_escape_string($_POST["aeheadername"][$i]);
        ...
        $template4=mysql_query("INSERT INTO `primary_template4_event`
...
if(isset($_POST['template5'])){
  ...
  $uptemp = mysql_query("UPDATE primary_template5 SET title = '$title', description = '$desc1'
   WHERE id = '$temp5id'");
...
unlink($tempremove);
       ...
       $temppath = "primary_template5/"; // create folder 
       ...
       $qur = mysql_query("UPDATE primary_template5 SET bannerimage = '$tempN' WHERE id = '$temp5id'");
...
if(isset($_POST['template6'])){
  ...
  $uptemp = mysql_query("UPDATE primary_template6 SET title = '$title', description = '$desc1'
   WHERE id = '$temp6id'");
...
if($tempremove!= "")
{
       ...
       $temppath = "primary_template6/"; // create folder 
       ...
       $qur = mysql_query("UPDATE primary_template6 SET bannerimage = '$tempN' WHERE id = '$temp6id'");
...
<div class="container">
 ...
 <?php if(isset($message)){ ?> 
  ...
  <h2 style="border:#000; padding:10px; background-color: #B2DBB2;margin: 10px 184px;color: #626262;border-radius: 4px;" id="showsccessmesg"><?php echo $message; ?></h2>
  ...
  <div class="subScreenheader">   
    ...
    $getlink = mysql_query("SELECT * FROM primary_template_content WHERE id = '$getelement'");
    ...
    $fetctlink = mysql_fetch_array($getlink);
     ...
     ?>
        ...
        <ul class="subscreenAdd">
          ...
          <li id="subclass1" class="activesub"><a href="transcare_edit_templates.php?scid=<?php echo $fetctlink['id']; ?>&tn=<?php echo $fetctlink['tablename']; ?>&temp_id=<?php echo $fetctlink['template_id']; ?>">Subscreen 1</a></li>
          <?php 
           $geteTemp = mysql_query("SELECT * FROM primary_template_content WHERE parentid = '$getelement' ORDER BY `primary_template_content`.`id` ASC ");
...
{
?>
  <div style="float:right;"><a href="addExtraPrimarySubscreen.php?screenid= <?php echo $getelement; ?> &&screen=screen<?php echo $subcount;?>" class="addSubscreenButton">Add subscreen</a></div>
<?php
}
?>
        ...
        <div class="fillContent" id="subscreen1">        
           ...
           <div class="section2">
                ...
                <?php 
                  ...
                  $getimage = mysql_query("SELECT * FROM primary_template1_carousal WHERE template_content_id = '$getelement'");
 ...
 <?php 
  ...
  <input type="text" id="edittemplate1_rightimage<?php echo $i; ?>" name="hiddenedittemplate1rgtimgs<?php echo $i; ?>" value="<?php echo $fetcImg["template1_rightimages"];?>" class="upLoadText">
          ...
          <div class="deLete">
              ...
              <a href="javascript:void(0);"  onClick="editremovetemplate1rightfiles(<?php echo $fetcImg["id"]; ?>,<?php echo $i;?>);"></a>
...
<!-- <div class="section2">
            ...
            $getimage = mysql_query("SELECT * FROM primary_template2_carousal WHERE template_content_id = '$getelement'");
 ...
 <?php 
        ...
        <input type="text" id="edittemplate2_rightimage<?php echo $i; ?>" name="hiddenedittemplate2rgtimages<?php echo $i; ?>" value="<?php echo $fetcImg["template2_rightimages"];?>" class="upLoadText">
          ...
          <div class="deLete">
              ...
              <label class="imgCaption"> Caption</label>
              <div style="clear:both;"></div>
              <input type="text" name="edittemplate2videocaption<?php echo $i; ?>" class="fillTitleText" value=" <?php echo $fetcImg["Imagecaption"];?>" >
...
?>
   ...
   <input type="hidden" id="temp2updateid" name="hiddentemplate2id" value="<?php echo $counttemplate2Im;?>">
     ...
     if($get_template_id == 3){
      ...
      $query = mysql_query("SELECT * FROM primary_template3 WHERE template_content_id = ".$getelement."");
...
while($fetchMulti = mysql_fetch_array($getMultiple)){
    ...
    <div class="addMore" id="template2addbutton">
     ...
     if($get_template_id == 4){
      ...
      $query = mysql_query("SELECT * FROM primary_template4 WHERE template_content_id = ".$getelement."");
                        ...
                        <input type="hidden" name="gettopImage5" value="<?php echo $fetquery['bannerimage']; ?>">
                             ...
                             <!-- <p class="imageView4">filename.jpg</p>
                              ...
                              <div class="deLete">
                                    ...
                                    <a href="javascript:void(0);" onClick="removetemplate5banner()"></a>
...
<div id="loader" style="display:none;"><img src="LoaderIcon.gif" alt="" />Loading!</div>
         <div class="save" style="margin:40px 0;width: 204px;">
              ...
              <input type="submit" value="Save" name="editSave" class="save_button" id="btnSubmit">
...
function editremovetemplate1rightfiles(id,appendid)
  {
    $.ajax({
        url: "deleteprimarysubscreen.php",
        type: "post",
