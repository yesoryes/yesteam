...

{
	...
	$query="Delete from   templates where id='$del'";
...
if(isset($_GET["primaryvalue"]))

{

	$del=$_GET["primaryvalue"];


	$query="Delete from primary_template_content where id='$del'";
...
//Adding details
	...
	$tickerText = mysql_real_escape_string($_POST['tickerText']);
	...
	if(isset($_POST['edit_details'])){
		...
		$etickerText = mysql_real_escape_string($_POST['etickerText']);
...
/*$(document).ready(function(){
	setTimeout('myremoveFunction()', 5000);
});
...
<div class="container">
    ...
    <div class="mainContent"> 
        ...
        <?php if(isset($_GET['subadd'])){ ?>
        	<div class="">

        	<h2 style="border:#000; padding:10px; background-color: #B2DBB2; margin-top: 10px;color: #626262;border-radius: 4px;"><?php echo $_GET['subadd']; ?></h2>
    	...
    	<div class="mainTitle">
         ...
         <?php
        $dbquery = mysql_query("SELECT * FROM `site_setting`");
        $getCou = mysql_num_rows($dbquery);
        if($getCou > 0)
        {
        	?>
        	 <div style="clear:both;">
        <a href="transcare_add.php?val=editdetails" class="addstarts">Edit</a>
        </div>
        ...
        ?>
         <div style="clear:both;">
        <a href="transcare_add.php" class="addstarts">Add</a>
        </div>
        <div style="clear:both;"></div>
        <?php
    }
    ?>
        ...
        <div class="contentSec">
        	...
        	<div class="contentSecTitle">
                  ...
                  <h3 style="line-height: 20px">Logo Image<br>
<span style="color:#000; font-weight: 100; font-size: 12px;">(Note : size 276px x 130px "PNG" image)</span></h3>
...
<span style="color:#000; font-weight: 100; font-size: 12px;">(Note : size 1920px x 918px)</span></h3>
             ...
             <div class="manage_details">
            	...
            	<img src="<?php echo $fetchque['bg_image']; ?>" style="height:200px">
        ...
        <div class="section2">
        	...
        	<div class="contentSecTitle">
        		...
        		<h3 style="line-height: 20px">Rotating Image - Main <br>
<span style="color:#000; font-weight: 100; font-size: 12px;">(Note : It Should be Rounded "PNG" image size 635px x 635px)</span></h3>
			 ...
			 ?>
            	...
            	<img src="<?php echo $fetrim['rotate_image_main']; ?>" style="margin:10px; height:150px;">
         ...
         <div class="section2">
        	...
        	<div class="contentSecTitle">
				...
				<h3 style="line-height: 20px">Rotating Image - Idle<br>
<span style="color:#000; font-weight: 100; font-size: 12px;">(Note : size 1632px x 918px)</span></h3>
			 ...
			 ?>
            	...
            	<img src="<?php echo $fetrim['rotate_image_idle']; ?>" style="margin:10px; height:150px;">
        ...
        <div class="innerScr">
        	 ...
        	 <div class="innerScrP">
					...
					$gettemp1 = mysql_query("SELECT * FROM primary_template_content WHERE parentid=0");
                     $count=mysql_num_rows($gettemp1);
					if($count > 0){
$i=1;
	 ...
	 <h5> <?php echo $fetchTemp1["linkname"] ?></h5>
	                       ...
	                       <div class="inrEdit">
                        		...
                        		<a href="transcare_edit_templates.php?scid=<?php echo $fetchTemp1['id']; ?>&tn=<?php echo $fetchTemp1['tablename']; ?>&temp_id=<?php echo $fetchTemp1['template_id']; ?>" ></a>

             	  			 </div>

                           <div class="inrDelete">

                        		<a href="transcare_manage.php?primaryvalue= <?php echo $fetchTemp1["id"] ?>"></a>
...
?>                   <?php
                        ...
                        <div class="addScreen">
                        		...
                        		<a href="Primarysubscreen.php?screenid=0&&screen=screen1"></a>
              ...
              <div class="innerScrS"> 
                    ...
                    <div class="innerScrContent"  style="overflow:auto;height:395px;">
