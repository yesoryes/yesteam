...
if(ress)
          {
                  ...
                  if(getcurrentmonth === month)
                  {
                          ...
                          document.write("<TD class='displayEvent'><a href='javascript:void(0);' style='color:rgb(65, 255, 0);border: 1px solid #fff; height:27px;' data-events="+todaydate+">"+day+"</a></TD>")
                          }
                          else
                          {
                             document.write("<TD class='displayEvent'><a href='javascript:void(0);' style='border: 1px solid #fff; height:27px;' data-events="+cc+">"+day+"</a></TD>")
          ...
          else
          {
                    ...
                    if(getcurrentmonth === month)
                    {
                              ...
                              document.write("<TD class='displayEvent'><a href='javascript:void(0);' style='color:#fff;border: 1px solid #2EC33D; height:27px; background-color: #31D742;' data-events="+todaydate+">"+day+"</a></TD>")
                              }
                              else
                              {
...
function getEventDetails(id)
{
    ...
    $.ajax({
      ...
      $getevent = mysql_query("SELECT * FROM `template3event` WHERE tl3_id = '$linkId' AND date = '$date'");
        ...
        <div class="venue_details" id="newEventDetails">
          ...
          <?php }
           ...
           ?>
            ...
            <input type="hidden" value="<?php echo $indicount; ?>">
    ...
    <!--IMG POPUP-->
    <?php
    $getpopupdata = mysql_query("SELECT * FROM `template3event` WHERE tl3_id = '$linkId' AND date = '$date'");
    $j=1;
    ...
    <div id="myModal<?php echo $j; ?>" class="modal_box popbox">
      ...
      <div class="popup_container">
        ...
        <div class="popup_text contentHolder"  id="boxscroll1">
        <div class="vertical-scroll boxscroll">
        <div class="" id="">
    ...
    <!--End--> 
      ...
      <div class="container">
        ...
        ?>    
          ...
          <div <?php if($row['id'] == $gettid) { ?>class="btn_active" <?php } ?>><div class="btn_left"><a href="inner-template-<?=$row['template_id']?>.php?dbname=<?php echo $row['table_name']; ?>&tcid=<?php echo $row['id']; ?>&cur=<?php echo $row['id']; ?>" class="foo_btn"><?php echo $row['linkname']; ?></a></div>
        ...
        $sel1 = mysql_query("SELECT * FROM template_content WHERE parentid = '$cur'");
           ...
           <div <?php if($row1['id'] == $gettid) { ?>class="btn_active" <?php } ?>><div class="btn_left"><a href="inner-template-<?=$row1['template_id']?>.php?dbname=<?php echo $row1['table_name']; ?>&tcid=<?php echo $row1['id']; ?>&cur=<?php echo $cur; ?>" class="foo_btn"><?php echo $row1['linkname']; ?></a></div>
          <div class="btn_right"></div>
            </div>
