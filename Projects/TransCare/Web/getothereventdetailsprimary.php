...
include('connect.php');
    ...
    if(isset($_POST['cont'])){
          $id = $_POST['cont'];
          $att = $_POST['att'];
       $getevent1 = mysql_query("SELECT * FROM `primary_template3_event` WHERE date = '$id' AND tl3_id = '$att'");
         ...
         <div id="owl-demo" class="owl-carousel">
          ...
          <?php } ?>
            <!--</ul>-->
                 ...
                 <?php
    $getpopupdata = mysql_query("SELECT * FROM `primary_template3_event` WHERE date = '$id'");
    $j=1;
    ...
    <div class="backdropajx"></div>
      ...
      <div class="popup_container">
        ...
        <div class="popup_text contentHolder" id="scr-calendar-pop">
        	<div class="scr_calendar2 boxscrollajax">
          <div class="" id="">
